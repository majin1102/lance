...
pub struct DataFile {
    ...
    /// The base path index of the datafile, when the datafile is a reference to another dataset.
    /// used as the key in base_paths in manifest.
...
impl DataFile {
    ...
    pub fn refer(datafile: &Self, path_base_index: u32) -> Self {
        Self {
            ...
            base_index: Some(path_base_index),
        }
    }
            ...
            json!({
                ...
                "files":[
                    {"path": "foobar.lance", "fields": [0], "column_indices": [], 
                     ...
                     "file_size_bytes": null, "base_index": null }
                ],
